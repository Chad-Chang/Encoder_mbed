...
void L298LIB::setSpeed(float pwmVal){pwm_ = pwmVal;}
float L298LIB::getSpeed(){return pwm_;}
void L298LIB::forward(){pinIN1_ = 1; pinIN2_ = 0;}
void L298LIB::backward(){pinIN1_ = 0; pinIN2_ = 1; }
void L298LIB::stop(){pinIN1_ = 0 ; pinIN2_= 0; }    
